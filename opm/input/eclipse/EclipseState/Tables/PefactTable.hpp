 ...
 */
#ifndef OPM_PARSER_PEFACT_TABLE_HPP
#define OPM_PARSER_PEFACT_TABLE_HPP
...
namespace Opm {
    ...
    class PefactTable : public SimpleTable {
    public:
        PefactTable( const DeckItem& item, const int tableID );
